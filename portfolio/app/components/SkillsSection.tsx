...
const skills = ['Java', 'Python', 'C++', 'Javascript', 'OCaml', 'SQL'];
const technologies = ['TypeScript', 'React', 'Node.JS', 'Next.js', 'TailwindCSS', 'MongoDB', 'MySQL', 'AWS', 'TensorFlow', 'PyTorch', 'Docker', 'Git'];
